...
// Source: C:\Users\Oasis\go\src\geekgo-webook\internal\service\article.go
//
// Generated by this command:
//
//	mockgen.exe -source=C:\Users\Oasis\go\src\geekgo-webook\internal\service\article.go -destination=C:\Users\Oasis\go\src\geekgo-webook\internal\service\mocks\article.mock.go -package=svcmocks
//
...
import (
	context "context"
	domain "geekgo-webook/internal/domain"
	reflect "reflect"
...
func (m *MockArticleService) Publish(ctx *gin.Context, article domain.Article) (int64, error) {
	m.ctrl.T.Helper()
